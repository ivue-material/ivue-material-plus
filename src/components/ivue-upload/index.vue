    ...
    >
      ...
      <slot>
        <div :class="inputContentClasses" :style="getSizeStyle(previewSize)">
          <!-- 图标 -->
          <ivue-icon :class="`${prefixCls}-content__icon`"
            >cloud_upload</ivue-icon
          >
