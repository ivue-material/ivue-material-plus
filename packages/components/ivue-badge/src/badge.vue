<template>
  ...
  <span :class="bem.b()" v-if="dot">
    <slot></slot>
    <!-- dot -->
    <sup :class="dotClasses" :style="supStyles" v-show="showBadge"></sup>
  </span>
  <!-- 状态点的颜色 -->
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const countSlotsClasses = computed(() => {
      ...
      return [bem.e('count'), bem.is('slot'), _color];
    });
    ...
    const statusClasses = computed(() => {
      ...
      return [bem.be('status', 'dot'), _color];
    });
