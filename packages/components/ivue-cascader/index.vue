      ...
      >
        <div>
          ...
          <div
            ...
            v-show="
              filterable && data.queryData !== '' && querySelections.length
            "
          >
          ...
          <ul
            ...
            "
          >
            <li :class="`${prefixCls}-not-found-tip-text`">
              {{ notFoundText }}
            </li>
          </ul>
        </div>
...
export default defineComponent({
  ...
  setup(props: Props, { emit }) {
    ...
    const querySelections = computed(() => {
      ...
      function getSelections(arr: Options[], label: string, value: string) {
        arr.forEach((item) => {
          // label
      ...
      () => {
        ...
        if (validDataStr !== data.validDataStr) {
          ...
          if (!data.isLoadedChildren) {
            nextTick(() => updateSelected(false, props.changeOnSelect));
          }
