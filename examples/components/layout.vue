<template>
  <div>
    ...
    <h1>排水沟</h1>
    <p>
      默认情况下，布局之间没有空格，这对于常规布局有点不好，例如卡牌, 您可以使用
      ivue-gutter 为自动计算元素之间的空间，这些空间基于屏幕宽度：
    </p>
    ...
    <h1>对齐</h1>
    <p>
      使用ivue-alignment-[horizontal]-[vertical]类，例如ivue-alignment-top-center。对齐适用于父元素，并将影响所有子项的位置
    </p>
    <div class="example">
    ...
    <h1>尺寸</h1>
    <p>
      布局系统根据项目数量计算子项大小。但是如果你想为每个项目设置尺寸？您只需ivue-size-[amount]在项目中设置一个，例如ivue-size-30。总是以％表示的大小可以是5的倍数，也可以接受值33和66。
    </p>
    <div class="ivue-layout ivue-gutter">
    ...
    <h1>响应</h1>
    <p>
      加入类 ivue-[breakpoint]-size-[amount]
    ...
    <h1>隐藏元素</h1>
    <p>
      在较小的屏幕上隐藏元素的需求是相当普遍的。你可以使用这些ivue-[breakpoint]-hide类来做到这一点
    </p>
