<template>
    <div>
        ...
        <p>large</p>
        <ivue-input v-model="value1" size="large" placeholder="large size"></ivue-input>
        <p>default</p>
        <ivue-input v-model="value1" placeholder="default size"></ivue-input>
        <p>small</p>
        <ivue-input v-model="value1" size="small" placeholder="small size"></ivue-input>
        ...
        <ivue-input
            ...
            size="small"
        ></ivue-input>
        <ivue-input clearable prefix="face" v-model="value1" type="password" suffix="search"></ivue-input>
        ...
        <ivue-input v-model="value1" search @on-search="handleSearch" size="large"></ivue-input>
        <p>1</p>
        <ivue-input v-model="value1" search enter-button size="small"></ivue-input>
        <p>1</p>

        <ivue-input v-model="value1" search enter-button="Search" size="large"></ivue-input>
        <p>1</p>
        ...
        <p>rows</p>
        <ivue-input v-model="value1" type="textarea" :rows="4"></ivue-input>
